...
namespace App\Models {
     ...
     * @property string $name
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<hakakses>|hakakses whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<hakakses>|hakakses whereName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<hakakses>|hakakses whereEmail($value)
     * @method static \Illuminate\Database\Eloquent\Builder<hakakses>|hakakses whereEmailVerifiedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<hakakses>|hakakses wherePassword($value)
     * @method static \Illuminate\Database\Eloquent\Builder<hakakses>|hakakses whereRole($value)
     * @method static \Illuminate\Database\Eloquent\Builder<hakakses>|hakakses whereRememberToken($value)
     * @method static \Illuminate\Database\Eloquent\Builder<hakakses>|hakakses whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<hakakses>|hakakses whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<hakakses>|hakakses newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<hakakses>|hakakses newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<hakakses>|hakakses query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class hakakses extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
